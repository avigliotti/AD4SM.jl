...
"""
    Tria06(nodes, p0; mat=Materials.NO_MAT, bReduced=false)
...
"""
    Quad09(nodes, p0; mat=Materials.NO_MAT, bReduced=false)
...
"""
    Quad08(nodes, p0; mat=Materials.NO_MAT, bReduced=false)
...
"""
    Tet10(nodes, p0; mat=Materials.NO_MAT, bReduced=false)
...
"""
    Hex27(nodes, p0; mat=Materials.NO_MAT, bReduced=false)
...
"""
    ASTria06(nodes, p0; mat=Materials.NO_MAT)
...
function ASTria06(nodes::Vector{<:Integer},
                  p0::Vector{<:AbstractVector{T}};
                  mat=Materials.NO_MAT) where T<:Number
...
"""
    ASQuad08(nodes, p0; mat=Materials.NO_MAT, bReduced=false)
