...
# withuot history
function getϕ(F::AbstractMatrix{D}, d::U, ∇d::AbstractVector{V}, mat::PhaseField{<:Material,:ATn}) where {D,U,V}
...
function getϕ(F::AbstractMatrix{D}, d::U, ∇d::AbstractVector{V}, mat::PhaseField{<:NeoHooke,:ATn}) where {D<:Number,U<:Number,V<:Number}
...
function getϕ(F::AbstractMatrix{D}, d::U, ∇d::AbstractVector{V}, mat::PhaseField{M,:DHn} where M) where {D,U,V}
...
#
# with history
function getϕ(F::AbstractMatrix{D}, d::U, ∇d::AbstractVector{V}, mat::PhaseField{<:Material,:ATn}, ϕmax::Tuple{Number,Number}) where {D,U,V}
...
function getϕ(F::AbstractMatrix{D}, d::U, ∇d::AbstractVector{V}, mat::PhaseField{NeoHooke,:ATn}, ϕmax::Number) where {D<:Number,U<:Number,V<:Number}
...
# deviatoric/hydrostatic
function getϕ(F::AbstractMatrix{D}, d::U, ∇d::AbstractVector{V}, mat::PhaseField{<:Material,:DHn}, ϕmax::Tuple{Number,Number}) where {D,U,V}
